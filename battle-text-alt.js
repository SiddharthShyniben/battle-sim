module.exports = {
  default: {
    startBattle:
      "[TRAINER], in combination with [TRAINER], shall commence battling forthwith!",
    ...
    boost2FromZEffect:
      "  [POKEMON] boosted its [STAT] twice using its Z-Power!",
    boost3FromZEffect:
      "  [POKEMON] boosted its [STAT] a lot using its Z-Power!",
    boostMultipleFromZEffect:
    ...
    swapOffensiveBoost:
      "  [POKEMON] switched all changes to its Strength and Intelligence with its target!",
    swapDefensiveBoost:
      "  [POKEMON] switched all changes to its Armor and Resistance with its target!",
    copyBoost: "  [POKEMON] copied [TARGET]'s stat changes!",
    clearBoost: "  [POKEMON]'s stat changes were removed!",
    clearBoostFromZEffect:
  ...
  auroraveil: {
    start:
      "  Aurora Veil made [TEAM] stronger against physical and special moves!",
  ...
  focusenergy: {
    ...
    startFromZEffect:
      "  [POKEMON] boosted its critical-hit ratio using its Z-Power!",
  },
  focuspunch: {
  ...
  battlebond: {
    activate:
      "  [POKEMON] became fully charged due to its bond with its Trainer!",
  ...
  safetygoggles: {
    block:
      "  [POKEMON] is not affected by [MOVE] thanks to its Safety Goggles!",
  },
  ultranecroziumz: {
